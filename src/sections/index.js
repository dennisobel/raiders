...
export { default as Management } from './Team/Management/Management';
export { default as Players } from './Team/Players/Players';
export { default as PlayerSingle } from './Team/PlayerSingle/PlayerSingle';


/*Fixture*/
export { default as Fixtures} from './Fixture/Fixtures/Fixtures';
export { default as FixtureSingle } from './Fixture/FixtureSingle/FixtureSingle';
